    ...
    render() {
        ...
        return (
            <div className="draw-container">
                <br></br>
                <Board dndImg={this.props.dndImg} uploadedImage={this.props.uploadedImage} setImg = {this.props.setImg} passedImage={this.props.passedImage} colour={this.state.isToggleOn ? 'ON' : 'OFF'}></Board>
